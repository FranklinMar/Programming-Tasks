...
- void show2(const double arr2[][3], int n);
  ...
  where inside show1() n – number of elements of array, and 
  inside show2() n – number of rows of array.
...
b) when calling function show2(), it must have compound literals,
   that consists of values 8, 3, 9 - values for the first row, 
   and of values 5, 4, 1 - values for the second row (and then 2).
------------------------------------------------------------
*/
#include <stdio.h>
#define N 3
